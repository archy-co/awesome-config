...
locker="i3lock -n --keylayout 2 -c 000000 --inside-color=ae3af2ff --ring-color=730fadff --modif-color=ff0000ff --wrong-text="" --verif-text="" --layout-color=d125fc30 --time-color=00000000 --date-color=00000000 --verif-color=adfc88ff --insidever-color=9148d6ff --ringver-color=b05ffcff --insidewrong-color=fc4235ff --noinput-text=""" 
