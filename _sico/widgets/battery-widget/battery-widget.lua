...
function battery_widget:init(args)
    ...
    -- set force_width of the widget
    self.widget:set_forced_width(70)

    -- set self widget margins
    self.widget.margins = {
    ...
    -- add 10 px padding to the widget from the right side
    --self.widget:set_padding(10, 0, 0, 0)
